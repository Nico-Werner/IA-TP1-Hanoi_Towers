...
def main():
    ...
    # Resuelve el problema utilizando búsqueda en profundidad con mejoría
    last_node = depth_best_first_search(problem_hanoi)
    ...
    if isinstance(last_node, NodeHanoi):
        ...
        # Imprimir el recorrido de la solución
        print(f'Solución: {last_node.path()}')
